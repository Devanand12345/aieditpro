  ...
  return (
    <div style={{ minHeight: "100vh", padding: "3rem 1.5rem", background: "linear-gradient(135deg, #0f172a 0%, #1e1b4b 100%)" }}>
      <div style={{ maxWidth: "800px", margin: "0 auto" }}>
        ...
        <h1 style={{ fontSize: "2rem", fontWeight: 800, marginBottom: "0.5rem", color: "#ede9ff" }}>UUID Generator</h1>
        <p style={{ color: "rgba(220,210,255,0.72)", marginBottom: "2rem" }}>Generate UUIDs (v1 and v4)</p>

        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem", marginBottom: "2rem" }}>
          <div>
            <label style={{ display: "block", fontSize: "0.9rem", fontWeight: 600, color: "#c4b5fd", marginBottom: "0.5rem" }}>UUID Version</label>
            <div style={{ display: "flex", gap: "1rem" }}>
              <label style={{ display: "flex", alignItems: "center", gap: "0.5rem", color: "#c4b5fd", cursor: "pointer", fontSize: "0.875rem" }}>
          ...
          <div>
            <label style={{ display: "block", fontSize: "0.9rem", fontWeight: 600, color: "#c4b5fd", marginBottom: "0.5rem" }}>Number of UUIDs</label>
            <input
              type="number"
              min="1"
              max="100"
        ...
        {uuids.length > 0 && (
          <div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem" }}>
              <div style={{ fontSize: "0.9rem", fontWeight: 600, color: "#c4b5fd" }}>Generated UUIDs ({uuids.length})</div>
              <button
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem", maxHeight: "400px", overflow: "auto" }}>
              {uuids.map((uuid, idx) => (
                ...
                >
                  <code style={{ color: "#86efac", fontFamily: "monospace", fontSize: "0.875rem", wordBreak: "break-all" }}>
                    {uuid}
                  </code>
                  <button
